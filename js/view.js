  ...
  UI_ELEMENTS.WEATHER_DETAILS.innerHTML = `
    <h4 class="info__details-city">${data.name}</h4>
      <ul class="info__details-list">
        <li class="info__details-item">Temperature: ${Math.round(
          data.main.temp
        )}°</li>
        <li class="info__details-item">Feels like: ${Math.round(
          data.main.feels_like
        )}°</li>
        <li class="info__details-item">Weather: ${data.weather[0].main}</li>
        <li class="info__details-item">Sunrise: ${formatTime(
          data.sys.sunrise
        )}</li>
        <li class="info__details-item">Sunset: ${formatTime(
          data.sys.sunset
        )}</li>
      </ul> 
    `;
            ...
            <div class="info__forecast-box forecast-box">
                ...
                <div class="forecast-box__bottom">
                    <ul class="forecast-box__list">
                        <li class="forecast-box__item">Temperature: ${Math.round(
                          item.main.temp
                        )}°</li>
                        <li class="forecast-box__item">Feels like: ${Math.round(
                          item.main.feels_like
                        )}°</li>
                    </ul>
                    <div class="forecast-box__weather">
                        <p class="forecast-box__text">${
                          item.weather[0].main
                        }</p>
